    ...
    <main class="registro-contenedor">
        <div class="registro-caja">
            ...
            <div class="Perfil-Container">
                ...
                <img class="profilePreview" id="profilePreview" src="<?= htmlspecialchars($usuario['foto_perfil']) ?>" alt="Foto de perfil" />
                ...
                <div class="divInfo">
                    <form id="info_usuarioForm">
                        <div class="form-grupo">
                            ...
                            <input type="text" id="nombre" name="nombre_usuario" value="<?= htmlspecialchars($usuario['nombre']) ?>"
                        ...
                        <div class="form-grupo">
                            ...
                            <input type="text" id="apellido_paterno" name="apellido_paterno" value="<?= htmlspecialchars($usuario['apellido']) ?>"
                                autocomplete="username" />
                            <div class="error-message"></div>
                        </div>
                        ...
                        <div class="form-grupo">
                            ...
                            <input type="text" id="apellido_materno" name="apellido_materno" value="<?= htmlspecialchars($usuario['nombre_usuario']) ?>"
                                autocomplete="username" />
                            <div class="error-message"></div>
                        </div>
